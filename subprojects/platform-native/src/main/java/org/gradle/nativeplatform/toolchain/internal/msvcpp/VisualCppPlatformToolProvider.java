...
class VisualCppPlatformToolProvider extends AbstractPlatformToolProvider {
    ...
    protected Compiler<WindowsMessageCompileSpec> createWindowsMessageCompiler() {
        ...
        WindowsMessageCompiler windowsMessageCompiler = new WindowsMessageCompiler(buildOperationProcessor, commandLineTool, context(commandLineToolConfigurations.get(ToolType.WINDOW_RESOURCES_COMPILER)), addIncludePathAndDefinitions(WindowsMessageCompileSpec.class), objectFileExtension, false);
