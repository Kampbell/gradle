...
class WindowsMessageCompiler extends VisualCppNativeCompiler<WindowsMessageCompileSpec> {
    ...
    WindowsMessageCompiler(BuildOperationExecutor buildOperationExecutor, CompilerOutputFileNamingSchemeFactory compilerOutputFileNamingSchemeFactory, CommandLineToolInvocationWorker commandLineTool, CommandLineToolContext invocationContext, Transformer<WindowsMessageCompileSpec, WindowsMessageCompileSpec> specTransformer, String objectFileExtension, boolean useCommandFile) {
        super(buildOperationExecutor, compilerOutputFileNamingSchemeFactory, commandLineTool, invocationContext, new McCompilerArgsTransformer(), specTransformer, objectFileExtension, useCommandFile);
    }
